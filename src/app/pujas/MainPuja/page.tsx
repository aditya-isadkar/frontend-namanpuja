...
export const metadata: Metadata = {
  title: 'All Poojas',
  description: 'Browse pujas by occasion, deity, service type, and location.',
};
...
export default async function PujaCategoryPage({ searchParams }: Props) {
      ...
      <div className="flex flex-col gap-8 lg:flex-row">
        ...
        <aside className="w-full shrink-0 rounded-2xl bg-[#faf5ec] p-5 lg:w-64">
          ...
          <div className="space-y-3">
            ...
            {/* <input
              ...
              className="w-full rounded-lg border border-saffron-200 bg-white px-3 py-2 text-sm text-ink/80 placeholder:text-ink/40 focus:border-saffron-400 focus:outline-none"
            /> */}
          </div>
        </aside>
        ...
        <main className="flex-1">
          ...
          <div className="mb-6 flex flex-wrap items-center gap-1 rounded-xl border border-saffron-100 bg-white px-4 py-3 text-sm text-ink/60">
            ...
            <Link href="?sort=popular" className="px-2 hover:text-saffron-700">Most popular</Link>
            <span className="text-ink/30">|</span>
            <Link href="?sort=alpha" className="px-2 hover:text-saffron-700">Alphabetical</Link>
            <span className="text-ink/30">|</span>
            <Link href="?sort=date" className="px-2 hover:text-saffron-700">Nearest date</Link>
          </div>
